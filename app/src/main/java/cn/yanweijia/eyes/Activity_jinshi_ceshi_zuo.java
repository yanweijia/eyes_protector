...
public class Activity_jinshi_ceshi_zuo extends Activity 
{
	...
	{
		Toast.makeText(Activity_jinshi_ceshi_zuo.this,
				"您的视力测试结果:\n小数视力"+shili.getXiaoShu()+"\n整数视力"+shili.getZhengShu(),
				Toast.LENGTH_LONG).show();
		Intent intent_result = new Intent();
		intent_result.setClass(Activity_jinshi_ceshi_zuo.this, Activity_jinshi_result.class);
		intent_result.putExtra("you_xiaoshu", you_xiaoshu);
		intent_result.putExtra("you_zhengshu", you_zhengshu);
		intent_result.putExtra("zuo_xiaoshu", shili.getXiaoShu());
		intent_result.putExtra("zuo_zhengshu", shili.getZhengShu());
		Activity_jinshi_ceshi_zuo.this.startActivity(intent_result);
		finish();
	}
}
